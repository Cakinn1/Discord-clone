...
import { ChatBubble, Inbox, Mood, Search } from "@mui/icons-material";
    ...
    <div className="flex flex-col h-screen">
      ...
      >
        <div className="flex items-center space-x-1">
          <HashtagIcon className="h-6 text-[#72757d]" />
      ...
      <div className="flex items-center p-2.5 bg-[#40444b] mx-5 mb-7 rounded-lg">
        ...
        <form className="flex-grow">
          <input
            ...
            className="bg-transparent focus:outline-none text-[#dcddde] w-full placeholder-[#72767d]
          text-sm"
            ref={inputRef}
          />
