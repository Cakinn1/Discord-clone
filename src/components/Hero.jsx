  ...
  return (
    <div className="bg-discord_blue pb-8 md:pb-0">
      <div className="p-7 py-9 h-screen md:h-[83vh] md:flex relative">
        ...
        <div className="flex-grow xl:">
          <img
            src="https://carlosloayza.com/images/e92fcc9ab6e63c1a17e954af347a1f1d.svg"
            alt=""
            className="absolute -left-36 mt-16 sm:-left-44 md:hidden"
          />
          <img
            src="https://carlosloayza.com/images/7b01f72a2054561145b6dd04add417c0.svg"
            alt=""
